        ...
        <div class="card-footer">
            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <p class="card-text">Philippine Airlines (PAL), a trade name of PAL Holdings, Inc. and also known historically as 
                                        Philippine Air Lines until 1970, is the flag carrier of the Philippines.</p>
                    </div>
                    <div class="card-footer">
                    </div>
                </div>
